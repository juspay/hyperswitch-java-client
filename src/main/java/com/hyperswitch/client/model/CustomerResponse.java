...
public class CustomerResponse {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(customerId, hashCodeNullable(name), hashCodeNullable(email), hashCodeNullable(phone), hashCodeNullable(phoneCountryCode), hashCodeNullable(description), hashCodeNullable(address), createdAt, hashCodeNullable(metadata));
  }
