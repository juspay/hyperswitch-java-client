...
public class OrderDetailsWithAmount {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(productName, quantity, amount, hashCodeNullable(requiresShipping), hashCodeNullable(productImgLink), hashCodeNullable(productId), hashCodeNullable(category), hashCodeNullable(brand), hashCodeNullable(productType));
  }
